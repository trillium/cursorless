...
describe("mergeOverlappingDecorations", () => {
    ...
    expect(result).toEqual(
      expect.arrayContaining([
        expect.objectContaining({
          ...
          properties: {
            class: expect.stringContaining("hat default selectionRight"),
          },
          alwaysWrap: true,
        }),
      ]),
  ...
  it("separates overlapping sections into their own items", () => {
    ...
    const overlapClasses =
      typeof classValue === "string" ? classValue.split(" ") : [];
    expect(overlapClasses).toEqual(
      expect.arrayContaining(["A", "B", "overlap"]),
    );
    ...
    expect(result).toEqual(
      expect.arrayContaining([
        ...
        expect.objectContaining({
          ...
          properties: {
            class: expect.stringContaining("thatMark selectionRight"),
          },
          alwaysWrap: true,
        }),
      ]),
    ...
    expect(result).toEqual(
      expect.arrayContaining([
        ...
        expect.objectContaining({
          ...
          properties: {
            class: expect.stringContaining("thatMark selectionLeft"),
          },
          alwaysWrap: true,
        }),
      ]),
